        ...
        <div className="flex min-h-screen bg-carbon">
            ...
            <div className="w-16 md:w-20 bg-graphite border-r border-white/5 flex flex-col items-center py-6 gap-8 sticky top-0 h-screen">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {/* PASTE THE NEW BUTTON HERE */}
                    <button
                        onClick={() => navigate('/host/list')}
                        className="p-3 rounded-xl transition-all relative group text-white/40 hover:text-volt hover:bg-white/5 border border-transparent hover:border-white/10"
                    >
                        <Bolt size={20} />
                        <span className="absolute left-16 bg-graphite text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-white/10 z-50">
                            List My Spot
                        </span>
                    </button>
                </div>
